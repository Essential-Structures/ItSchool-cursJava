...
//12.Write a Java program to get a collection view of the values contained in this map.
        Collection<Integer> mapValuesAsSet = new HashSet<>();
        for (Map.Entry <String, Integer> mapEntry : mapCopy.entrySet()) {
            mapValuesAsSet.add(mapEntry.getValue());
        }
        System.out.println("Map values viewed as set: " + mapValuesAsSet);
